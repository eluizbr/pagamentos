...
import { CostumerResult } from 'src/modules/costumers/entities/costumer.result.entity';
import { ResultTokenDto } from 'src/modules/tokens/entities/result-token.entity';
